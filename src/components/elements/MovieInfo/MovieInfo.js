    ...
    >
      <div className="rmdb-movieinfo-content">
        <div className="rmdb-movieinfo-thumb">
          <MovieThumb image={props.movie.backdrop_path ? `${IMAGE_BASE_URL}${POSTER_SIZE}${props.movie.poster_path}` : './images/no_image.jpg'} clickable={false} />
        </div>
        <div className="rmdb-movieinfo-text">
          ...
          {props.directors.lengh > 1 ? <h3>DIRECTORS</h3> : <h3>DIRECTOR</h3>}
